...
link_name = ["/server/rest/services/SIGAP_Interaktif/Zonasi_dan_Blok_Kawasan_Konservasi/MapServer/1"]

class moefSigapKLHK(scrapy.Spider):
    name = "moef_sigap_zkonservasi"
    ...
    def parse_query_post(self, response):
        ...
        output_dir = f'./output_json_local/SIGAP_collection/output_json_{layer_name}_zone_konservasi'  # Define your output directory
