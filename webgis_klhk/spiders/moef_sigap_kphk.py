...
link_name = ["/server/rest/services/SIGAP_Interaktif/Kesatuan_Pengelolaan_Hutan/MapServer/1"]

class moefSigapKLHK(scrapy.Spider):
    name = "moef_sigap_kphk"
    ...
    def parse_query_post(self, response):
        ...
        output_dir = f'./output_json_local/SIGAP_collection/output_json_{layer_name}_kphk'  # Define your output directory
